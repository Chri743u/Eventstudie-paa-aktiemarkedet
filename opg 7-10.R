...
epsilon_STJ = VYi_STJ - Xi_STJ%*%thetahat
...
CAR7=t(gamma)*eps #trække epsilon værdierne ud fra tau_1 til tau_2
CAR_BAR7=sum(CAR7) #summer over epsilon værdierne 
...
SCAR7=CAR7/sqrt(sig) #scar_hat udregnes
SCAR_BAR7=sum(SCAR7) #der summes over scar_hat, som giver scar_bar

(J_1=sum(CAR7)/sqrt(sum(sigma2hat))) #teststørrelsen J_1 er givet
